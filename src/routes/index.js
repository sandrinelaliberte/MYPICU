...
import Analytics from 'components/dashboards/dash2';
import Optiheart from 'components/dashboards/optiheart';
import Optibrain from 'components/dashboards/optibrain';
import Optilungs from 'components/dashboards/optilungs';
import Optistate from 'components/dashboards/optistate';
...
import Ecommerce from 'components/dashboards/dash1';
import Lms from 'components/dashboards/dash3';
import Patientmanagement from 'components/dashboards/patientmanagement';
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: paths.optiheart,
                element: <Optiheart />
              },
              {
                path: paths.optibrain,
                element: <Optibrain />
              },
              {
                path: paths.optilungs,
                element: <Optilungs />
              },
              {
                path: paths.optistate,
                element: <Optistate />
              },
              {
